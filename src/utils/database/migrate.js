...
class DatabaseMigration {
  ...
  async migrate() {
    ...
    try {
      ...
      console.log("=".repeat(50));
      console.log(
        `📈 Summary: ${successCount}/${setupResults.size} databases migrated successfully`
      );
  ...
  async rollback() {
    ...
    try {
      ...
      console.log("=".repeat(50));
      console.log(
        `📈 Summary: ${successCount}/${cleanupResults.size} databases rolled back successfully`
      );
  ...
  async testConnections() {
    ...
    try {
      ...
      console.log("=".repeat(40));
      console.log(
        `📈 Summary: ${successCount}/${connectionResults.size} connections successful`
      );
